...
def create_rank_fact_recommender(sf_ratings, hike_side_data):
    model = gl.recommender.ranking_factorization_recommender.create(sf_ratings, user_id='variable', item_id='hike_id', target='value', item_data=hike_side_data, regularization=1e-10, linear_regularization=1e-8)
...
if __name__ == '__main__':
    ...
    create_rank_fact_recommender(sf_ratings, hike_side_data)
